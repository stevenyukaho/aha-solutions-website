...
import { differentItems } from '@/lib/data';

export function DifferentStrip() {
  return (
    <div className="card" style={{ padding: 36, marginBottom: 20 }}>
      <div className="mono" style={{ fontSize: 10.5, letterSpacing: 1.6, color: 'var(--accent)', marginBottom: 20 }}>WHAT MAKES THIS DIFFERENT</div>
      <div className="different-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20 }}>
        {differentItems.map((it, i) => (
